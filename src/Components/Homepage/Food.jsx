...
const Food = () => {
  ...
  const fetchData = () => {
    // Fetch data here, replace the URL with the correct endpoint for your "Food" data
    fetch('http://localhost:3001/posts')
      ...
      .then((data) => {
        const filteredItems = data.filter((item) => item.serviceType === 'Food');
  ...
  return (
    <section>
         <section className="py-5" id="Food">
        <div>
          <div className="row">
