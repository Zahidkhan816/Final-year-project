...
const Photography = () => {
  ...
  const fetchData = () => {
    // Fetch data here, replace the URL with the correct endpoint for your "Photography" data
    fetch('http://localhost:3001/posts')
      ...
      .then((data) => {
        const filteredItems = data.filter((item) => item.serviceType === 'Photography');
  ...
  return (
    <section>
         <section className="py-5" id="Photography">
        <div>
          <div className="row">
